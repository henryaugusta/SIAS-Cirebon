        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                      {{-- <a href="{{ route('op-berkas.cf')}}" target="_blank" class="btn btn-icon icon-left btn-primary">
                        ...
                        <div class="input-group mb-3">
                            <a href="" onclick="this.href='op-berkas/cetak-pertanggal/'+document.getElementById('tglawal').value + '/'+document.getElementById('tglakhir').value"
