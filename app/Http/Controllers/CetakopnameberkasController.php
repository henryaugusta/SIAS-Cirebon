    ...
    function convert_opname_berkas_to_html()
    {
        ...
        <table width="100%" style="border-collapse: collapse; border: 0px;">
            <tr>
                ...
                <th style="border: 1px solid; font-size: 14px; padding:5px;" >Kode Klasifikasi</th>
                ...
                <th style="border: 1px solid; font-size: 14px; padding:5px;" >Uraian Informasi</th>
                <th style="border: 1px solid; font-size: 14px; padding:5px;" >Jumlah Berkas</th>
                <th style="border: 1px solid; font-size: 14px; padding:5px;" >Jumlah Berkas Ada</th>
                <th style="border: 1px solid; font-size: 14px; padding:5px;" >Jumlah Berkas Tidak Ada</th>
        ...
        foreach ($opname_berkas as $tampil) {
            ...
            <tr >
                ...
                <td style="border: 1px solid; font-size: 14px; padding:5px;">' . $tampil->jml_berkasada . '</td>
                <td style="border: 1px solid; font-size: 14px; padding:5px;">' . $tampil->jml_berkastidakada . '</td>
        ...
        $output .= '
            <tr>
                <td align="right" colspan="12" style="border: 1px solid; padding:3px;">
