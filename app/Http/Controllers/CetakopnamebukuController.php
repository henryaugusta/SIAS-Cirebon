    ...
    function convert_opname_buku_to_html()
    {
        ...
        <table width="100%" style="border-collapse: collapse; border: 0px;">
            <tr>
                ...
                <th style="border: 1px solid; font-size: 14px; padding:5px;" >Buku</th>
                ...
                <th style="border: 1px solid; font-size: 14px; padding:5px;" >Jumlah Buku</th>
        ...
        foreach ($opname_buku as $tampil) {
            ...
            <tr>
                ...
                <td style="border: 1px solid; font-size: 14px; padding:5px;">' . $tampil->jml_buku . '</td>
