...
Route::group(['middleware' => ['auth']], function () {
    ...
    //cetak pertanggal
    Route::get('op-berkas/cetak-form', 'OpnameberkasController@cetakform')->name('op-berkas.cf');
    Route::get('op-berkas/cetak-pertanggal/{tglawal}/{tglakhir}', 'OpnameberkasController@cetakpertanggal')->name('op-berkas.cpt');
